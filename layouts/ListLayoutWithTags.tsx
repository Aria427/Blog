    ...
    <>
      <div>
        <div className="pt-6 pb-6">
          <h1 className="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:hidden sm:text-2xl sm:leading-10 md:text-4xl md:leading-14 dark:text-gray-100">
            {title}
          </h1>
        </div>
